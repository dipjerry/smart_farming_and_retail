function randowStringGenerate() {
   ...
   * @param {com.strawberrysupplychain.system.BatchCultivation} BatchCultivation
   * @transaction
   */
  async function BatchCultivation(tx) {
      ...
      var Batch = await getFactory().newResource('com.strawberrysupplychain.system', 'BatchAsset', BatchId);
      //Get asset registry reference
      const assetRegistry = await getAssetRegistry('com.strawberrysupplychain.system.BatchAsset');
      ...
      const participantRegistry = await getParticipantRegistry('com.strawberrysupplychain.participant.SystemUser');
    ...
    console.log(tx.cultivator)
      let event = await getFactory().newEvent('com.strawberrysupplychain.system', 'BatchProcess');
   ...
   * @param {com.strawberrysupplychain.system.BatchFarmInspection} BatchFarmInspection
   * @transaction
   */
  async function BatchFarmInspection(tx) {
      ...
      BatchData.strawberryFamily  = tx.strawberryfamily;
   ...
   * @param {com.strawberrysupplychain.system.BatchHarvest} BatchHarvest
   * @transaction
   */
  async function BatchHarvest(tx) {
      ...
      BatchData.strawberryVariety = tx.strawberryvariety;
  ...
  /**
   * BatchExport
   * @param {com.strawberrysupplychain.system.BatchExport} BatchExport
   * @transaction
   */
  ...
  /**
   *  BatchImport
   * @param {com.strawberrysupplychain.system.BatchImport} BatchImport
   * @transaction
   */
  ...
  /**
   * BatchProcessor
   * @param {com.strawberrysupplychain.system.BatchProcessor} BatchProcessor
   * @transaction
   */
